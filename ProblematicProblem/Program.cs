...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //bool isOldEnough = int.TryParse(Console.ReadLine(), out int userAge);
            Console.WriteLine();
            ...
            { Console.WriteLine("Okay, we will surprise you!"); }
            ...
            while (cont == true)
            {
                ...
                cont = Console.ReadLine().ToUpper() == "REDO" ? true : false;
            }
        }
